  ...
  return (
    ...
    flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8">
        ...
        <p class="italic text-center font-bold text-gray-800 mb-4">
          Kindly refresh to see changes
        </p>
        <form onSubmit={addTodo} className="flex items-center gap-2 shadow-sm border
                ...
                <div key={todo._id}>
                  {editingTodo === todo._id ? (
                    <div className="flex items-center gap-x-3">
                      ...
                      outline-none focus:ring-2 focus:ring-blue-300 text-gray-700
                      shadow-inner" 
                      type="text" 
                      value={editedText} 
                      ...
                      <div className="flex gap-x-2">
                        <button type = "button"
                        onClick={() => {saveEdit(todo._id); setEditingTodo(null)}}
                    ...
                    <div>
                      ...
                      justify-between">
                        ...
                        <div className="flex gap-x-2">
                          ...
                          hover:text-blue-700 rounded-lg hover:bg-blue-50 duration-200" 
